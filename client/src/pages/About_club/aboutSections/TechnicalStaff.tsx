...
// TypeScript interface for TechnicalStaff
...
// Data
const TechnicalStaffData: TechnicalStaff[] = [
  {
    id: 1,
...
// Individual Card
const TechnicalStaffCard: React.FC<TechnicalStaffCardProps> = ({ TechnicalStaff }) => {
  return (
    <div
    ...
    >
      ...
      <div className="relative p-6 z-10">
        ...
        <div className="flex justify-center mb-4">
          <img
            src={TechnicalStaff.image}
            alt={`${TechnicalStaff.name} - ${TechnicalStaff.designation}`}
            loading="lazy"
            onError={(e) => {
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-wrap gap-2">
            {TechnicalStaff.fieldsOfResearch.map((field) => (
              <span
                key={`${TechnicalStaff.id}-${field}`}
...
// Main component
const TechnicalStaffCards: React.FC = () => {
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 place-items-center">
        {TechnicalStaffData.map((TechnicalStaff) => (
          <TechnicalStaffCard key={TechnicalStaff.id} TechnicalStaff={TechnicalStaff} />
        ))}
      </div>
    </div>
  );
...
export default TechnicalStaffCards;
