      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          <motion.img
            ...
            alt="HOD"
            className="w-full max-w-sm h-auto object-cover pt-20 rounded-lg shadow-2xl"
          ...
          >
            ...
            >
              ...
              instrumentation, control systems, and industrial automation. Following
              an Outcome-Based Education (OBE) approach, we integrate electronics,
              electrical engineering, and computer science principles.
            </motion.p>
            ...
            >
              ...
              industry-ready skills through qualified faculty guidance and modern
              facilities.
            </motion.p>
          </motion.div>
        </div>
