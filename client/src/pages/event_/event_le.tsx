  ...
  return (
    <div className="min-h-screen  p-6 pt-20">
      <div className="max-w-3xl mx-auto  rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6">
          <h1 className="text-3xl font-bold mb-4 text-amber-200">{event?.title}</h1>
          <p className="text-blue-200 mb-2">
            <span className="font-semibold">Date:</span> {event?.date && new Date(event?.date).toLocaleDateString()}
          </p>
          <p className="text-blue-200 mb-4">
            <span className="font-semibold">Last Date:</span> {event?.lastdate && new Date(event?.lastdate).toLocaleDateString()}
          </p>
